<template>
    <section id="post_section" class="position-relative">
        ...
        <div class="site-pagination">
            <a href="#post_section" @click="GetPosts(index)" v-for="index in paginate" :class="current==index ? 'active disable' : ''" :key="index">{{AddLeadingZero(index)}}.</a>
        </div>
    </section>
</template>
